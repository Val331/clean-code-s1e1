...
var addButton=document.querySelector(".add-element__button");//first button
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-input input-text input";
...
var editTask=function(){
    ...
    if(containsClass){
        ...
        editInput.classList.remove('input_edit');
        label.classList.remove('task-name_edit');
        label.innerText=editInput.value;
        editBtn.innerText="Edit";
    }else{
        editInput.classList.add('input_edit');
        label.classList.add('task-name_edit');
...
var taskCompleted=function(){
    ...
    listItem.querySelector('label').className='task-name completed-tasks__label';
}
...
//Mark task as incomplete.
    ...
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
    listItem.querySelector('label').className='task-name';
}
